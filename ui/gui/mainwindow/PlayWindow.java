...
public class PlayWindow {
    ...
    // Effects: creates a window
    public PlayWindow(Pet pet, Timer mainTimer) {
        initilize(pet, mainTimer);
    }

    // Effects: creates a window
    public void initilize(Pet pet, Timer mainTimer) {
        JFrame timedWindow = new JFrame("Play Window");
    ...
    public void full(Pet pet, JFrame timedWindow) {
        ...
        if (pet.getHappyLevel() == 100) {
            JLabel label = new JLabel("I am already very happy!");
            ImageIcon notEat = new ImageIcon(new ImageIcon("src/main/Image/PlayWindow/alreadyHappyPet.png").getImage()
            ...
            JLabel label = new JLabel("This is fun! I am so happy! Thank you for playing with me!");
            pet.play();
            ImageIcon notEat = new ImageIcon(new ImageIcon("src/main/Image/PlayWindow/happyPet.png").getImage()

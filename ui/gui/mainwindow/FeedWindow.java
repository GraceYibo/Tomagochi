...
public class FeedWindow {
    ...
    public FeedWindow(Pet pet, Timer mainTimer) {
        initilize(pet, mainTimer);
    }

    // Effects: creates a window
    public void initilize(Pet pet, Timer mainTimer) {
        JFrame timedWindow = new JFrame("Feed Window");
    ...
    public void full(Pet pet, JFrame timedWindow) {
        ...
        if (pet.getFullness() == 100) {
            JLabel label = new JLabel("I am full! Feed me when I am hungry please!");
            ImageIcon notEat = new ImageIcon(new ImageIcon("src/main/Image/FeedWindowImage/fullPet.png").getImage()
            ...
            JLabel label = new JLabel("Yum! Thank you for feeding me!");
            pet.feed();
            ImageIcon notEat = new ImageIcon(new ImageIcon("src/main/Image/FeedWindowImage/petEat.png").getImage()
                    .getScaledInstance(300, 300, Image.SCALE_SMOOTH));
            label.setIcon(notEat);
            panel.add(label);
            timedWindow.add(panel, BorderLayout.CENTER);

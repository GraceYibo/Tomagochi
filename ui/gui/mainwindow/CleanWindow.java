...
public class CleanWindow {
    ...
    public CleanWindow(Pet pet, Timer mainTimer) {
        initilize(pet, mainTimer);
    }

    // Effects: creates a window
    public void initilize(Pet pet, Timer mainTimer) {
        JFrame timedWindow = new JFrame("Clean Window");
    ...
    // Effects: creates a window
    public void full(Pet pet, JFrame timedWindow) {
        JPanel panel = new JPanel();
        panel.setLayout(new FlowLayout(FlowLayout.CENTER, 10, 5));
        panel.setBackground(Color.WHITE);
        if (pet.getCleanessLevel() == 100) {
            JLabel label = new JLabel("I am Clean! Clean me when I am dirty please!");
            ImageIcon notEat = new ImageIcon(new ImageIcon("src/main/Image/CleanWindow/notCleanPet.png").getImage()
            ...
            JLabel label = new JLabel("Yay! I am cleaned! Thank you for cleanning me!");
            pet.clean();
            ImageIcon notEat = new ImageIcon(new ImageIcon("src/main/Image/CleanWindow/cleanPet.png").getImage()
